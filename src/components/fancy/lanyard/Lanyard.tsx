...
// Note: You need to add card.glb and lanyard.png to src/assets/lanyard/
// Download from: https://github.com/srm-kzilla/lanyard
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }: BandProps) {
  ...
  try {
    if (cardGLB) {
      ...
      nodes = {
        ...
        clip: { geometry: new THREE.BoxGeometry(0.1, 0.1, 0.1) },
    ...
    // Fallback geometry and materials
    nodes = {
      card: { geometry: new THREE.BoxGeometry(1.6, 2.25, 0.02) },
      clip: { geometry: new THREE.BoxGeometry(0.1, 0.1, 0.1) },
      clamp: { geometry: new THREE.BoxGeometry(0.1, 0.1, 0.1) }
  ...
  // Handle texture wrapping safely
  if (texture && 'wrapS' in texture) {
